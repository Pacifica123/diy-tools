...
| markdown_splitter | Нарезчик Markdown | text | M2 | P,G | cli/json_report | Win expected / Linux expected | no | no | tools/markdown_splitter | python scripts/smoke_test.py |
