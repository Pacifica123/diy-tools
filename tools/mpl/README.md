...
- `subgraph ...` / `end` как визуальные группы;
...
GUI рисует картинку в памяти через SVG-превью. Сохранение в PNG в первой версии не нужно. SVG можно сохранить вручную кнопкой `Сохранить SVG`.
...
- Простая раскладка: `src/mpl/core/layout.py`.
