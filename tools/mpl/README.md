...
- отсутствие визуального наложения top-level subgraph;
- ABI JSON;
...
- Простая раскладка: `src/mpl/core/layout.py`; там же защита от раздувания canvas на циклах, перенос широких слоёв, разнос top-level subgraph и базовая сортировка узлов для уменьшения пересечений.
